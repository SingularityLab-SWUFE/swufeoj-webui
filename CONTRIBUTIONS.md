...
1. **Keep scope small**: One feature or fix per PR
2. **Write clear description**: Your PR description becomes permanent documentation
3. **Update docs**: Include documentation for API changes
